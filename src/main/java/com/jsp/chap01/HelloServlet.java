...
@WebServlet("/hello") // 우리 웹 서버에 /hello라는 URL로 요청이 오면 이 서블릿을 실행하라
public class HelloServlet extends HttpServlet { // Httpservlet을 상속받습니다.


    // 기본 생성자
    public HelloServlet() {
        // 요청이 들어오면 서블릿 객체가 서버 내에서 자동으로 생성됨.
        System.out.println("\n\n\n Hello 서블릿 작동 시작!!! \n\n\n");
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // 요청이 들어오면 자동으로 실행되는 메서드
        // 매개값으로 요청에 대한 정보가 담긴 HttpServletRequestdhk
